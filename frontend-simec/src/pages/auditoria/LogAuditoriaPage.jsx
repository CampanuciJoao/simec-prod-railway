// src/pages/auditoria/LogAuditoriaPage.jsx
    ...
    <>
      <section className="page-section">
        <h3
          ...
          style={{ fontSize: '1.1em', textTransform: 'none', fontWeight: '600' }}
        >
        ...
        <div className="relatorio-filtros-container">
          ...
          <div className="filtro-agrupador-datas">
            <div className="form-group">
              <label>
                <FontAwesomeIcon icon={faCalendarAlt} /> Data Início
              </label>
              <DateInput
                name="dataInicio"
            ...
            <div className="form-group">
              <label>
                <FontAwesomeIcon icon={faCalendarAlt} /> Data Fim
              </label>
              <DateInput
                name="dataFim"
              ...
              {loading && logs.length === 0 ? (
                <tr>
                  <td colSpan="5" className="table-message">
                    <FontAwesomeIcon icon={faSpinner} spin /> Carregando logs...
                  </td>
                </tr>
              ) : logs.length > 0 ? (
                logs.map((log) => (
                  <tr key={log.id}>
                    ...
                    <td>
                      <span
                        className={`status-badge status-${log.acao
                          .toLowerCase()
                          .replace(/_/g, '-')}`}
                      >
                        {log.acao}
