// src/pages/gerenciamento/GerenciarUsuariosPage.jsx
  ...
  return (
    <div className="form-container-inline" style={{ padding: '25px' }}>
      <form onSubmit={handleSubmit}>
        <h4 style={{ marginTop: 0, fontSize: '1.2em' }}>
          {isEditing
        ...
        <div className="info-grid" style={{ gridTemplateColumns: '1fr 1fr' }}>
          ...
          <div className="form-group" style={{ position: 'relative' }}>
            ...
            <FontAwesomeIcon
              ...
              onClick={() => setConfirmaSenhaVisivel((p) => !p)}
              style={{
                position: 'absolute',
                right: '12px',
                top: '38px',
        ...
        <div className="form-group" style={{ maxWidth: 'calc(50% - 12.5px)' }}>
...
function GerenciarUsuariosPage() {
  ...
  const handleSaveUsuario = async (formData) => {
    ...
    try {
      ...
      addToast(
        err.response?.data?.message || 'Ocorreu um erro ao salvar o usuário.',
        'error'
      );
    } finally {
                      ...
                      <tr key={user.id}>
                        ...
                        <td className="actions-cell">
                          ...
                          <button
                            ...
                            disabled={usuarioLogado?.id === user.id}
                          >
