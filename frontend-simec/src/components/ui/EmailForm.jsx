// Ficheiro: frontend-simec/src/components/ui/EmailForm.jsx
  ...
  return (
    <form onSubmit={handleSubmit} className="form-elegante" noValidate>
      ...
      <div className="form-section" style={{ paddingTop: '15px', marginTop: '15px' }}>
        ...
        <div className="checkbox-group">
          <div className="checkbox-item">
            <input
              type="checkbox"
              name="recebeAlertasContrato"
              checked={formData.recebeAlertasContrato}
              onChange={handleChange}
              id="cb-contrato"
            />
            <label htmlFor="cb-contrato">Contratos</label>
          </div>

          <div className="checkbox-item">
            <input
              type="checkbox"
              name="recebeAlertasManutencao"
              checked={formData.recebeAlertasManutencao}
              onChange={handleChange}
              id="cb-manutencao"
            />
            <label htmlFor="cb-manutencao">Manutenções</label>
          </div>

          <div className="checkbox-item">
            <input
              type="checkbox"
              name="recebeAlertasSeguro"
              checked={formData.recebeAlertasSeguro}
              onChange={handleChange}
              id="cb-seguro"
            />
            <label htmlFor="cb-seguro">Seguros</label>
          </div>
        </div>
      </div>
      ...
      <div
        ...
        style={{ borderTop: 'none', paddingTop: '10px', marginTop: '20px' }}
      >
        <button
          type="button"
